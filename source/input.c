...
int input_read_parameters_species(struct file_content * pfc,
  ...
  class_call(parser_read_double(pfc, "cotton", &param4, &flag4, errmsg),
           errmsg,
           errmsg);
   
  class_call(parser_read_double(pfc, "n_cotton", &param5, &flag5, errmsg),
           errmsg,
           errmsg);

  /* Test */
  class_test((flag4 == _FALSE_) && (flag5 == _FALSE_),
           errmsg,
           "You must specify values for both 'cotton' and 'n_cotton'.");
  ...
  /*class_call(parser_read_double(pfc, "eos_cotton", &param6, &flag6, errmsg),
           errmsg,
           errmsg);
  class_test((flag6 == _FALSE_),
           errmsg,
           "You must specify values for both 'eos_cotton'.");
  if (flag6 == _TRUE_) {
      // pba->eos_cotton = param6;
      }*/
